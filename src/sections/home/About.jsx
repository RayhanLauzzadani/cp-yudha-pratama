      ...
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row lg:items-center items-start gap-10 px-6 sm:px-10">
        ...
        <div className="text-[#383737] lg:w-1/2 text-left relative z-40 lg:mt-0 -mt-10">
          ...
          <Link
            to="/about#sejarah"
            role="button"
            className="inline-block mt-6 px-6 py-2 sm:px-7 sm:py-2.5 md:px-8 md:py-3 border border-[#A20000] rounded-full text-[#A20000] text-[11px] sm:text-[13px] md:text-[14px] font-semibold tracking-wide hover:bg-[#A20000] hover:text-white transition-all duration-300 ease-out"
          >
            BACA LEBIH LANJUT
          </Link>
        </div>
